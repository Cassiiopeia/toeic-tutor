...
1. **Q8 — 기본 정보 두 가지** — 표에서 날짜·장소·시작 시각 중 질문이 묻는 두 가지를 찾아 답한다. (15초)
2. **Q9 — 정정** — 질문 속 정보를 표와 대조하고, 다르면 정정한다. "괜찮다/맞다" 로 답하기 전에 반드시 표를 다시 본다. (15초)
3. **Q10 — 나열** — 같은 종류의 항목 2~3개를 개수부터 밝히고 순서대로 나열한다. (30초, 60~75단어)

## v0 표현

### Q8 — 기본 정보
- "Sure, the ___ is on ___ , and it starts at ___ ."
- "It will be held at ___ , starting at ___ ."

### Q9 — 정정
- "I'm afraid that's not correct. Actually, ___ ."
- "Actually, according to the schedule, it's ___ , not ___ ."
...
9:30 a.m.   Opening Remarks             Grace Kim
10:00 a.m.  Q3 Sales Report             David Park
11:00 a.m.  New Product Launch Plan     Grace Kim
12:00 p.m.  Lunch                       —
```
...
- Q9 에서 표를 다시 확인하지 않고 무조건 "That's correct" 라고 답해버린다.
- Q9 정정 후 올바른 정보를 말하지 않고 "아니다" 로만 끝낸다 — 정정은 틀린 값과 맞는 값을 둘 다 말해야 끝난다.
- Q10 에서 개수를 안 밝히고 항목만 줄줄 나열한다 ("There are ___" 생략).
- Q8 이 묻는 두 정보 중 하나를 빠뜨리고 하나만 답한다.
- 표에 없는 정보를 지어내 답한다.
