...
**🐛 수정**
- rules — 성적표 확인용 표는 인쇄 순서·배치 그대로 만든다 — 재정렬하면 사용자가 대조를 못 한다 (§3.2)
...
**🔧 변경사항**
- rules : add : init 에 토익 점수 기반 토스 출발 등급 추정(2b-2) · levels.md·resources.md 참조 연결
- docs : add : 외부 자료 지도(resources.md) — 공식/토익스토리/무료진단/사설(시계토끼)/앱 을 출처 등급으로 구분
- speaking : add : 공식 등급표·등급별 요구수준·토익 상관관계표(levels.md) — IM1/2/3 세분화 · 2022.6.4 개정 내역 · Calibration Test · IH·AL 경계 상충 해소
...
**🔧 변경사항**
- speaking : add : 토스 처음 보는 사람용 온보딩 문서 · init 에서 경험 없으면 먼저 안내
